...
{
	static public ChannelEventFutureListener	CLOSE					= new ChannelEventFutureListener()
																					{
																						@Override
																						public
																								void
																								onAction(ChannelEventFuture future)
																						{
																							future.getEvent()
																									.getChannel()
																									.close();
	...
	static public ChannelEventFutureListener	CLOSE_ON_FAILURE	= new ChannelEventFutureListener()
																					{
																						@Override
																						public
																								void
