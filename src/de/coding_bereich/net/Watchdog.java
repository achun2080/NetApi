...
/**
 * Cronjob-Aufgabenverwaltung. Ruft, je nach Einstellungen,
 * 
 * @author Thomas
 * 
 */
public class Watchdog implements Runnable
{
	...
	/**
	 * Fügt einen Listener hinzu. Dieser wird alle <em>intervalMillis</em>
	 * Millisekunden aufgerufen.
	 * 
	 * @param task
	 *           Der Listener.
	 * @param intervalMillis
	 *           Millisekunden angabe.
	 */
	...
	private void updateNextTask()
	{
		synchronized(taskList)
		{
			...
			while( it.hasNext() )
			{
				...
				long tempTime = task.getIntervallMillis()
						+ task.getLastExecMillis();
