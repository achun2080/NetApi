...
{
	public final static DateFormat RFC_1123_FORMAT = new SimpleDateFormat("EEE, dd MMM yyyyy HH:mm:ss z");
	...
	public void setCookie(String name, String value, Date expires, String path, String domain, boolean secure, boolean httpOnly)
	{
		...
		try
		{
			...
			buf.append("=");
			buf.append(URLEncoder.encode(value, HttpResponseEncoder.HEADER_CHARSET));
