...
/**
 * Eine Session trägt die Daten, eines (eingeloggten) Benutzer.
 * Der Nutzer wird per Cookie wieder erkannt.
 * @author Thomas
 *
 */
public class HttpSession
{
	 ...
	 * @param name Attributsname.
	 * @param value Den Wert des Attributes.
	 */
