 ...
 * Desweiteren bringt jeder Thread seine eigenen Byte- und Charbuffer mit. Dies
 * soll die Umwandlung von Bytes nach Chars oder umgekehrt beschleunigen.
 * 
 * @author Thomas
 * 
 */
public class WorkerPoolWorker extends Thread implements
		CharsetDecoderEncoderThread
{
	protected LinkedBlockingQueue<Object[]>	queue;
	protected boolean									run						= true;

	protected ByteBuffer								tempArrayByteBuffer	= ByteBuffer
																								.allocate(4096);
	protected CharBuffer								tempArrayCharBuffer	= CharBuffer
																								.allocate(4096);
